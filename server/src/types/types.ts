...
export type EventGalleryResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['EventGallery'] = ResolversParentTypes['EventGallery']
> = {
...
> = {
    postFeedback?: Resolver<
        ResolversTypes['FeedbackResponse'],
        ParentType,
        ContextType,
        RequireFields<MutationPostFeedbackArgs, 'input'>
    >;
};
...
export type PerformerResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['Performer'] = ResolversParentTypes['Performer']
> = {
...
export type PerformerGalleryResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['PerformerGallery'] = ResolversParentTypes['PerformerGallery']
> = {
    height?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    id?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
    image?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PerformerSocialResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['PerformerSocial'] = ResolversParentTypes['PerformerSocial']
> = {
...
export type PerformerVideoResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['PerformerVideo'] = ResolversParentTypes['PerformerVideo']
> = {
    default_thumbnail?: Resolver<Maybe<ResolversTypes['Thumbnail']>, ParentType, ContextType>;
    high_thumbnail?: Resolver<Maybe<ResolversTypes['Thumbnail']>, ParentType, ContextType>;
    id?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
> = {
    ...
    comments?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<QueryCommentsArgs, 'eventId'>
    >;
    event?: Resolver<ResolversTypes['Event'], ParentType, ContextType, RequireFields<QueryEventArgs, 'slug'>>;
    events?: Resolver<Array<ResolversTypes['Event']>, ParentType, ContextType>;
    participant?: Resolver<
        Maybe<ResolversTypes['Participant']>,
        ParentType,
        ContextType,
        RequireFields<QueryParticipantArgs, 'id'>
    >;
    participants?: Resolver<Array<ResolversTypes['Participant']>, ParentType, ContextType>;
    performer?: Resolver<
        Maybe<ResolversTypes['Performer']>,
        ParentType,
        ContextType,
        RequireFields<QueryPerformerArgs, 'slug'>
    >;
    performers?: Resolver<Maybe<Array<Maybe<ResolversTypes['Performer']>>>, ParentType, ContextType>;
};

export type ThumbnailResolvers<
    ContextType = DataSourceContext,
    ParentType extends ResolversParentTypes['Thumbnail'] = ResolversParentTypes['Thumbnail']
> = {
    height?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
